...
client = WebClient('xoxb-3567619742403-3567654388210-glscbg4cEJC3gISqdWmanYZl')
...
def add_blogs(request):
    ...
    #st = json.dumps(notis[0].data)
    #obj_format = json.loads(st, object_hook=lambda d: SimpleNamespace(**d))
    #obj_format = json.loads(obj_format.extras, object_hook=lambda d: SimpleNamespace(**d))
    #print(obj_format.link)
    #print(notis[0].data['subject'])
